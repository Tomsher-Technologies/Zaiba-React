...
const Banner: FC<{ sliders: any[] }> = ({ sliders }) => {
    ...
    return (
        <APIFetch lengthCheckObject={sliders} >
                    ...
                    >
                        {sliders.map((slider: any, index: number) => (
                            ...
                            <div className="banner-item" key={index}>
                                <img
                                    src={process.env.NEXT_PUBLIC_IMAGE_URL + "/storage/uploads/all/a5EwhgHYw1fbxcnZXLL67fEplteNpAt4YYfLmkKJ.jpg"}
                                    className="img-fluid"
                                    alt="Banner Image"
                                    width={200}
                                    height={160}
